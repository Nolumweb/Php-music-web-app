<head>
    ...
    <!-- DateTimePicker -->
    <link rel="stylesheet" href="style/dist/css/jquery.datetimepicker.min.css">
    <!-- iCheck for checkboxes and radio inputs -->
    <link rel="stylesheet" href="style/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Switch Toggle -->
    <!-- Ekko Lightbox -->
    <link rel="stylesheet" href="style/plugins/ekko-lightbox/ekko-lightbox.css">
    <link rel="stylesheet" href="style/plugins/bootstrap4-toggle/css/bootstrap4-toggle.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="style/dist/css/images-grid.css">
    <link rel="stylesheet" href="style/dist/css/adminlte.min.css">
    <link rel="stylesheet" href="style/dist/css/styles.css">
    
    <script src="style/plugins/jquery/jquery.min.js"></script>
  
      <script src="style/dist/js/images-grid.js"></script>
    <!-- jQuery UI 1.11.4 -->
